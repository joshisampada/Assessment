...
import com.atmecs.demoqawebsite.utils.ReadPropertyFile;
...
public class Helper extends TestBase
{
	public static WebElement returnWebElement(String element){
		...
		String locator_value=ReadPropertyFile.readProperty(ProjectPathConstants.objectrepo,element);
	...
	{  
		final String locator_value=ReadPropertyFile.readProperty(ProjectPathConstants.objectrepo,element);
